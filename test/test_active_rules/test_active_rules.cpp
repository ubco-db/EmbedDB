...
void test_MaxEqual(void) {
    ...
    int value = 5;
    int numLast = 5;
    state->rules[0]->IF(state->rules[0], 1, GET_MAX)->ofLast(state->rules[0], (void*)&numLast)->is(state->rules[0], Equal, (void*)&value)->then(state->rules[0], [](void* maximum, void* current, void* ctx) {
...
void test_MinGreaterThan(void) {
    ...
    int value = 2;
    int numLast = 3;
    state->rules[0]->IF(state->rules[0], 1, GET_MIN)->ofLast(state->rules[0], (void*)&numLast)->is(state->rules[0], GreaterThan, (void*)&value)->then(state->rules[0], [](void* minimum, void* current, void* ctx) {
        CallbackContext* context = (CallbackContext*)ctx;
        context->int1++;
...
void test_AvgLessThanOrEqual(void) {
    ...
    float value = 3.5;
    int numLast = 4;
    state->rules[0]->IF(state->rules[0], 1, GET_AVG)->ofLast(state->rules[0], (void*)&numLast)->is(state->rules[0], LessThanOrEqual, (void*)&value)->then(state->rules[0], [](void* average, void* current, void* ctx) {
        CallbackContext* context = (CallbackContext*)ctx;
        context->int1++;
...
void test_MultipleQueries(void) {
    ...
    int value1 = 5;
    int numLast = 5;
    state->rules[0]->IF(state->rules[0], 1, GET_MAX)->ofLast(state->rules[0], (void*)&numLast)->is(state->rules[0], Equal, (void*)&value1)->then(state->rules[0], [](void* maximum, void* current, void* ctx) {
        CallbackContext* context = (CallbackContext*)ctx;
        context->int1++;
        TEST_ASSERT_EQUAL_INT_MESSAGE(5, *(int*)maximum, "Callback did not return correct value.");
    });
    ...
    int value2 = 2;
    int numLast2 = 3;
    state->rules[1]->IF(state->rules[1], 1, GET_MIN)->ofLast(state->rules[1], (void*)&numLast2)->is(state->rules[1], GreaterThan, (void*)&value2)->then(state->rules[1], [](void* minimum, void* current, void* ctx) {
        CallbackContext* context = (CallbackContext*)ctx;
        context->int1++;
        TEST_ASSERT_TRUE(*(int*)minimum > 2);
    });
...
void test_CustomQuery(void) {
    ...
    int numLast = 10;
    state->rules[0]->IFCustom(state->rules[0], 1, GetWeightedAverage, DBFLOAT)->ofLast(state->rules[0], (void*)&numLast)  // last 10 seconds
    ...
    state->rules[1]->IF(state->rules[1], 1, GET_AVG)->ofLast(state->rules[1], (void*)&numLast)->is(state->rules[1], LessThanOrEqual, (void*)&(context->float1))->then(state->rules[1], [](void* result, void* current, void* ctx) {
        CallbackContext* context = (CallbackContext*)ctx;
...
void test_whereClause(void) {
    ...
    int minData = 3;
    int numLast = 4;
    state->rules[0]->IF(state->rules[0], 1, GET_MIN)->ofLast(state->rules[0], (void*)&numLast)->where(state->rules[0], (void*)&minData, NULL)->is(state->rules[0], GreaterThan, (void*)&value)->then(state->rules[0], [](void* mini, void* current, void* ctx) {
        CallbackContext* context = (CallbackContext*)ctx;
