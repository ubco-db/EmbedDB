...
typedef struct StreamingQuery {
    ...
    struct StreamingQuery* (*SQIF)(struct StreamingQuery *query, StreamingQueryType type);
    struct StreamingQuery* (*is)(struct StreamingQuery *query, SelectOperation operation, float threshold);
