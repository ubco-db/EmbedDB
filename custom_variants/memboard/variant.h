...
#include "WVariant.h"
#undef    DAC               // No DAC, so remove as this is based on Feather M0
#include <Arduino.h>
...
#define NUM_DIGITAL_PINS     (19ul)
#define NUM_ANALOG_INPUTS    (0ul)
#define NUM_ANALOG_OUTPUTS   (01ul)
 ...
 */
/** 
 * @TODO -> this is for preconfiged SPI */
#define SPI_INTERFACES_COUNT 1

/** Board needs at least one SPI */


/**
 * Sercom 0 configuration for SD card
 **/
#define MOSI_SD         2ul
#define SCLK_SD         3ul
#define MISO_SD         4ul
#define CS_SD           5ul
#define SD_SPI          sercom0


#define PIN_SPI_MISO          (4ul)
 ...
 * USB
 */
#define PIN_USB_HOST_ENABLE (46ul)
